...
* [一、线程](#一线程)
  ...
  * [线程状态](#线程状态)
    * [1. 新建（New）](#1-新建New)
    * [2. 可运行（Runnable）](#2-可运行Runnable)
    * [3. 阻塞（Blocked）](#3-阻塞Blocked)
    * [4. 无限期等待（Waiting）](#4-无限期等待Waiting)
    * [5. 限期等待（Timed Waiting）](#5-限期等待Timed-Waiting)
    * [6. 死亡（Terminated）](#6-死亡Terminated)
  * [线程生命周期](#线程生命周期)
  * [守护线程和用户线程](#守护线程和用户线程)
  * [上下文切换](#上下文切换)
  * [线程死锁](#线程死锁)
    * [1. 认识线程死锁](#1-认识线程死锁)
    * [2. 如何避免线程死锁?](#2-如何避免线程死锁)
  * [多线程并发编程](#多线程并发编程)
    * [1. 并发与并行概念解读](#1-并发与并行概念解读)
    * [2. 为什么要使用多线程?](#2-为什么要使用多线程)
    * [3. 多线程可能带来的问题](#3-多线程可能带来的问题)
* [二、线程的使用](#二线程的使用)
...
* [五、互斥同步](#五互斥同步)
  * [synchronized](#synchronized)
    * [synchronize使用](#synchronize使用)
    * [synchronize底层实现](#synchronize底层实现)
...
<div align="center"> <img src="/pictures/java-concurrent/Java 线程状态变迁.png" width="600px"> </div><br>


线程在生命周期中并不是固定处于某一个状态而是随着代码的执行在不同状态之间切换。Java 线程状态变迁如下图所示（图源《Java 并发编程艺术》4.1.4 节）：

<div align="center"> <img src="/pictures/java-concurrent/RUNNABLE-VS-RUNNING.png" width="600px"> </div><br>
...
<div align="center"> <img src="https://my-blog-to-use.oss-cn-beijing.aliyuncs.com/2019-4/2019-4%E6%AD%BB%E9%94%811.png" width="600px"> </div><br>
...
```
它和同步代码块一样，作用于同一个对象。作用于当前对象实例加锁，进入同步代码前要获得当前对象实例的锁
